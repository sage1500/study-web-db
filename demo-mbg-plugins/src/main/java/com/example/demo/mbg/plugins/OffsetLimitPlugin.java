package com.example.demo.mbg.plugins;
...
public class OffsetLimitPlugin extends PluginAdapter {
	...
	public boolean sqlMapSelectByExampleWithoutBLOBsElementGenerated(XmlElement element,
		...
		addOffsetLimitElements(element);
		return true;
	}
	...
	private void addOffsetLimitElements(XmlElement element) {
